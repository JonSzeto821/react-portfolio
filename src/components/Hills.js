...
export default class Footer extends Component {
  render() {
    return (
      <div className="hills">
        <svg className='pricing-deco-img' enableBackground='new 0 0 300 100' height='300px' id='Layer_1' preserveAspectRatio='none' version='1.1' viewBox='0 0 300 100' width='100%' x='0px'  xlinkHref='http://www.w3.org/1999/xlink' xmlns='http://www.w3.org/2000/svg' y='60px'>
